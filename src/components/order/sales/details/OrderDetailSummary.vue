...
export default {
  ...
  watch: {
    ...
    summary(data) {
      ...
      if (this.summary.retrievePeople !== null) {
        ...
        this.retrieve.name                = this.summary.retrievePeople.document.type == 'CNPJ' ? this.summary.retrievePeople.alias : `${this.summary.retrievePeople.name} ${this.summary.retrievePeople.alias}`;
        this.retrieve.document            = this.summary.retrievePeople.document.document;
      ...
      if (this.summary.deliveryPeople != null) {
        ...
        this.delivery.name                = this.summary.deliveryPeople.document.type == 'CNPJ' ? this.summary.deliveryPeople.alias : `${this.summary.deliveryPeople.name} ${this.summary.deliveryPeople.alias}`;
        this.delivery.document            = this.summary.deliveryPeople.document.document;
  ...
  methods: {
    ...
    getPayerOptions() {
      ...
      if (this.summary.retrievePeople == null || this.summary.retrievePeople == null) {
        opts.push({
          label: 'Não definido',
          value: -2,
        });
